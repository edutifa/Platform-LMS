...
export function CourseDetailBanner({ course }: Props) {
  return (
    <section className="bg-linear-to-br from-blue-50 pt-14 md:pt-24 via-white to-purple-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 border-b border-border/60">
