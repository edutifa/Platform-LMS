...
const courses: Course[] = [
  {
    ...
    imageSrc: "/images/sample-banner-course.png",
  },
  {
    id: 2,
    ...
    <section className="mx-auto max-w-6xl px-4 py-10">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        {courses.map((course) => (
          <Card
            key={course.id}
            className="overflow-hidden rounded-2xl border border-zinc-100 bg-white p-0 shadow-sm transition hover:-translate-y-1 hover:shadow-md dark:border-zinc-800 dark:bg-zinc-900 gap-0 py-0"
          >
