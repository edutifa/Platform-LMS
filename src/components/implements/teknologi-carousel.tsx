    ...
    <section className="pt-2">
      <div className="container px-4">
        ...
        <div className="flex justify-center relative">
          {/* Fade kiri */}
          <div className="absolute left-0 top-0 h-full w-32 bg-linear-to-r from-white to-transparent dark:from-neutral-950 z-10 pointer-events-none" />
          
          {/* Fade kanan */}
          <div className="absolute right-0 top-0 h-full w-32 bg-linear-to-l from-white to-transparent dark:from-neutral-950 z-10 pointer-events-none" />
          ...
          <div className="w-full max-w-6xl overflow-hidden" ref={emblaRef}>
            <div className="flex ml-4">
              {techStack.map((tech) => (
                <div
                  key={tech.id}
                  className="pl-1 basis-1/6 shrink-0"
                >
                  <div className="p-1">
